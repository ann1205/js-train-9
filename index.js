...
function findIndexByProperty(arr, name) {
  ...
  const needName = (element) => element.name === name;

  if (needName != undefined) {
    return arr.findIndex(needName);
  } else {
    return -1;
  }
}
...
function findLastEvenNumber(arr) {
  ...
  const evenNumber = (element) => element % 2 === 0;

  if (evenNumber != undefined) {
    return arr.findLast(evenNumber);
  } else {
...
function getArrayKeys(arr) {
  ...
  const keyArray = Array.from(iterator);
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  const map1 = flattenedArray.map((x) => x ** 2);
  const result = map1.filter((numb) => numb > threshold);
  return result;
}
...
function wordLengths(arr) {
  ...
  const map1 = arr.map((element) => element.length);
  return map1;
}
...
function findDuplicateElements(arr) {
  ...
  const duplicatesArray = arr.filter((element, index) => {
...
function capitalizeWords(arr) {
  ...
  const capitalizedWordsArray = arr.map((word) => {
...
function calculateTotalPrice(arr) {
  ...
  const result = arr.reduce((totalPrice, product) => {
...
function findLastNegativeNumberIndex(arr) {
  ...
  const negativeNumb = (element) => element < 0;

  return arr.findLastIndex(negativeNumb);
}
